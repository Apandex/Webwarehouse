                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" oninput="this.value = Math.abs(this.value)" value="<?php echo $d['prod_Cost']; ?>" class="form-control" placeholder="Enter text" name="prod_Cost" style="margin-bottom: 40px;" required />
                                        </div>
